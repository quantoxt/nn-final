    ...
    <div>
        ...
        <div v-if="error">
            <div>
                ...
                <NuxtLink @click="refresh">Retry</NuxtLink>
            </div>
        </div>
        <div v-else-if="isBookReady && book" class="big-book-card card mt-10">
            ...
            <div class="content">
                <div class="info">
                    ...
                    <div class="row ">
                        <span class="author">By: {{ book.profiles?.username || "Anonymous"}}</span>
                        <span class="category">
...
const { book, loading, error, refresh, isBookReady } = useSingleBook()


const formattedSaveCount = computed(() => {
    const saves = book.value?.saves
    if (typeof saves !== 'number' || saves === undefined) {
        return '0'
    }
