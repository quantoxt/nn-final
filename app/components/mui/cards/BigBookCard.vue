    ...
    <div class="content">
      ...
      <div class="stats">
        <div class="rating-details">
          ...
          <div class="mini-row">
            <span class="rate-count">10 Ratings</span>
      ...
      <div class="btn-wrap">
        <nuxt-link :to="`/category/${props.category}/${props.bookSlug}`">
...
const formattedSaveCount = computed(() => {
    if (typeof props.saveCount !== 'number') {
        return props.saveCount;
    }
    ...
    return formatter.format(props.saveCount);
});
</script>
