...
.latest-card {
  @apply mx-2 flex flex-col rounded-lg w-full gap-4 items-center max-w-[12em];
}
.img {
  img {
    @apply w-full h-47 object-cover rounded-lg;
  }
  @apply w-[11em];
}
.content {
  @apply flex flex-col gap-2.5 w-[10em];
}
.title {
...
.rating-saves {
  ...
  @apply flex flex-row justify-between text-sm text-gray-500;
}
.link {
  svg {
    @apply w-3.5 h-3.5;
